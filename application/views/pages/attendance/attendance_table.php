			...
			<div class="row">
				...
				<div class="col-md-3" align="right">
					...
					<?php if($action!="false"){?>
						...
						<a style="color: white" type="submit" name="csv" id="csv" class="btn btn-success"><i class="fa fa-file"></i> Excel</a>
				<?php }?>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="mymodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('admin/save_attendance');?>" method="POST" id="myform">
...
<div class="modal fade" id="myeditmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('admin/edit_attendance_new');?>" method="POST" id="editform">
      <div class="modal-body">
		<div class="card-body">
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						...
						<input type="hidden" name="course_id" id="course_id" value="<?php echo $course_id;?>">
						<span class="text-danger" id="date_error2"></span>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="myexportmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="<?php echo base_url('admin/export_csv/'.$course_id);?>" method="POST" id="myform">
      <div class="modal-body">
		<div class="card-body">
			<div class="form-group">
				<div class="row">
					<label class="col-md-4 text-right">From Date</label>
					<div class="col-md-8">
				...
				<div class="btn"></div>
				<div class="row">
					<label class="col-md-4 text-right">To Date</label>
					<div class="col-md-8">
		...
		$('#edit_date').change(function()
			{
				...
				$.ajax({
	    		url: "<?php echo base_url('admin/edit_chechdate');?>",
	    		method: "POST",
	    		data:{date:date,course_id:course_id},
	    		success:function(data)
	    		{

	    			$('#date_error2').text(data);
	    		}
	    	 });
